...
public class SvgLinesPainter extends SvgPainter {
	...
	protected HashMap<OutputDevice, String> getDeviceCss() {
		...
		defaultCss.append("#linecharts { stroke-width: " + width + "; stroke-dasharray: " + width * 5 + ", " + width * 5 + "; }").append(System.lineSeparator());
		defaultCss.append("#linechart-1 { stroke-dasharray: none; }").append(System.lineSeparator());
		defaultCss.append("#linechart-2 { stroke-dasharray: " + width + ", " + width * 3 + "; }").append(System.lineSeparator());
		
		deviceCss.put(OutputDevice.Default, defaultCss.toString());
		
		StringBuilder screenHighContrastCss = new StringBuilder();
		screenHighContrastCss.append("#linecharts { stroke-width: 1.5; stroke-dasharray: none; stroke: yellow;}").append(System.lineSeparator());
		screenHighContrastCss.append("#linechart-2 { stroke-dasharray: 2.0, 3.0; stroke: #00ffff;}").append(System.lineSeparator());
		screenHighContrastCss.append("#linechart-3 { stroke-dasharray: 5.0, 5.0; stroke: #ff00ff;}").append(System.lineSeparator());
